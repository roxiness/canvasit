...
test('$request creates a placeholder', t => {
    ...
    t.is(result, '__$REQUEST_["myPkg"]__myEval_$REQUEST__')

    result = $request('myPkg', 'myProp')('myEval')
    t.is(result, '__$REQUEST_["myPkg","myProp"]__myEval_$REQUEST__')
})

test('parse$request transforms placeholder and populates dependencies', t => {
    const _body =
        '__$REQUEST_["myPkg"]__myEval_$REQUEST__' + '\n' +
        '__$REQUEST_["myPkg","myProp"]__myEval_$REQUEST__'
